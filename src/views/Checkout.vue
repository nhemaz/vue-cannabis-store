       ...
       <Navbar></Navbar>
        ...
        <div class="container mt-5 pt-5">
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <h4 class="py-4" style="color:white">Checkout page</h4>
                     <ul>
                        ...
                        <div class="media-body">
                            <h5 class="mt-0" style="color:white">{{item.productName}}

                                <span class='float-right' @click="$store.commit('removeFromCart',item)">X</span>

                            </h5>
                            <p class="mt-0" style="color:white">{{item.productPrice | currency}}</p>
                            <p class="mt-0" style="color:white">Quantity : {{item.productQuantity }}</p>
                        </div>
                        </li>
