      ...
      <div class="container">
        ...
        <div class="intro h-100">
          ...
          <ul class="nav nav-pills ml-3" id="myTab" role="tablist">
            ...
            <li class="nav-item">
              <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="true" style="color:white">Profile</a>
            </li>

            <li class="nav-item">
              <a class="nav-link"  id="account-tab" data-toggle="tab" href="#account" role="tab" aria-controls="account" aria-selected="false" style="color:white">Account settings</a>
            </li>
