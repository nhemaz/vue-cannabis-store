      ...
      <div class="container">
        ...
        <div class="intro h-100">
            <div class="row h-100 justify-content-center align-items-center">
              <div class="col-md-6">
                    <h3 style="color:white">Orders Page</h3>
                    
                 <p style="color:white">
                   All the orders will be placed here.
                 </p>
              </div>
              <div class="col-md-6">
          ...
          <div class="product-test">
            ...
            <h3 class="d-inline-block" style="color:white">Orders list</h3>
            <button @click="addNew" class="btn btn-primary float-right" style="color:white">Add Orders</button>
