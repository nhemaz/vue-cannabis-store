      ...
      <div class="container">
        ...
        <div class="intro h-100">
            <div class="row h-100 justify-content-center align-items-center">
              <div class="col-md-6">
                    <h3 style="color:white">Products Page</h3>
          ...
          <div class="product-test">
            ...
            <h3 class="d-inline-block" style="color:white">Products list</h3>
            <button @click="addNew" class="btn btn-primary float-right" style="color:white">Add Product</button>
            ...
            <div class="table-responsive">
                ...
                <table class="table">
                  ...
                  <tbody>
                      <tr v-for="product in products" style="color:white">
                        <td>
                          {{product.name}}
                        </td>
